		...
		<div class="sixteen wide column">
			<div class="ui attached message">
				<h1 class="header">
					...
					<a class="ui right floated label blue" href="/list/add/<?= $resTodo->todo_id ?>/">Ajouter</a>
				</h1>
			</div>
				...
				<table class="ui celled selectable table">
					...
					<tbody>
                        <?php foreach( getTasks( $resTodo->todo_id ) as $resTask ): ?>
                            <tr onclick="location.href='/list/read/<?= $resTask->taskid ?>/'" style="cursor: pointer;">
                                ...
                                <td><a class="ui right floated label red" href="/list/delete/<?= $resTask->taskid ?>/">Supprimer</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
				</table>
